...
class LungesDetector(BaseExercise):
   ...
   def process(self, landmarks) -> dict:
      ...
      landmarks[front_knee_idx].visibility >= self.MIN_VISIBILITY and landmarks[front_ankle_idx].visibility >= self.MIN_VISIBILITY and 
      landmarks[shoulder_idx_for_torso].visibility >= self.MIN_VISIBILITY)
